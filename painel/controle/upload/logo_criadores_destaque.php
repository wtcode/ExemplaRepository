...
$GLOBALS['idcriadores_destaque'] = $_SESSION['idcriadores_destaque'];
...
function realizaUploadImagem($file, $tamanhoMaximo, $titulo) {
	include "../conect.php";
		...
		$nome_da_imagem = $handle->file_dst_name;
	  	...
	  	$idCliente = $GLOBALS['idcriadores_destaque'];

		$sqlInsertImage = "update criadores_destaque set patch_logo = '$imagem' where idcriadores_destaque = '$idCliente'";
