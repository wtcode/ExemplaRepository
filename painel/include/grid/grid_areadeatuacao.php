...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabela_form" id="resultado">
  ...
  <tr>
    <th colspan="8" class="titulo" align="center">
        Área de Atuação
        <a href="cadastramento.php?cad=6" style="float:right; position:relative; margin-right:10px;"><img src="images/add.png" /> <br />  Adicionar</a>
    </th>
  </tr>
  
  <tr>
    <td width="30%" class="titulo_grid">Título</td>
...
?>
  <tr bgcolor="<?php echo $cor; ?>" class="corpo_grid">
    ...
    <td class="corpo_grid"><a href="cadastramento.php?cad=6&idconteudo=<?php echo $idconteudo ?>&pg=<?php echo $idpagina ?>"><img src="images/document_edit.png"  title="Editar" alt="Editar"/></a></td>
    <td class="corpo_grid">
	    <a href="controle/delete/delete_areadeatuacao.php?id=<?php echo $idconteudo ?>" class="item-excluir" id="<?php echo $idconteudo ?>"><img src="images/delete2.png"  alt="Excluir"  title="Excluir"/></a>
	</td>
  </tr>
<?php
	}
