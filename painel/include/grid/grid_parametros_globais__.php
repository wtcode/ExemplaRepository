               ...
               <form action="" id="form_alterar" name="form_alterar" method="post" enctype="multipart/form-data">
                ...
                <span style="font-family:Arial, Helvetica, sans-serif; font-size:10px;float:left;">Layout</span>
                    ...
                    #FFF; margin:0px 0px 0px 0px;">
                     ...
                     Largura: <input class="input" type="text" style="width:40px;" name="larguraImgMiniatura" value="<?php echo $img_miniatura_altura['valorparametro']; ?>"/> px (Somente n�meros)
                     Altura: <input class="input" type="text" style="width:40px;" name="alturaImgMiniatura" value="<?php echo $img_miniatura_largura['valorparametro']; ?>" /> px (Somente n�meros)<br />
                     ...
                     Imagem de Fundo: <input class="input" type="file" name="imgDefundo" /> px (Somente n�meros)               
                      </div>
